...
function Denial() {
  return (
   ...
   <div className="container-fluid">
          ...
          <div className="content">
            <div className="col-md-6">
              <div className="text-section">
                ...
                <h1 className='text_h1'>Reduce Denials. Increase Revenue. Empower Your Business.​​</h1>
                <p className='text_p'><q>Knack Global partners with healthcare providers to identify the root causes of claim denials and reverse them, delivering time and cost savings to busy practices. </q></p>
                <a href="#contact_us" className="text_btn btn-primary"><span>Contact Us</span></a>
              </div>
            </div>
            <div className="image-section">
              <img src="https://knackglobal.com/wp-content/uploads/2023/04/Header_Denial-Management-Services-1536x1045.png" alt="Medical Center" />
            </div>
          </div>
        </div>
      ...
      <div className="oursolution mt-5">
        <div className="container-fluid">
          <div className="home_solution">
            <div className="col-md-2">
              ...
              <ul className='side_menu_two'>
                <li><a href="">MEDICAL CODING SERVICES</a></li>
              </ul>
              <ul className='side_menu'>
                <li><a href="">CHARGE ENTRY & CHARGE AUDIT</a></li>
              </ul>
            ...
            <div className="col-md-4">
              <div className="work_image_pay">
                <img src="https://knackglobal.com/wp-content/uploads/2023/04/Stress-Free-Denial-Management-1536x1536.png" alt="" />
              </div>
            </div>
            <div className="col-md-6">
              <h6 className='work_h6'>ProFimed Global</h6>
              <h1 className='h1_text'>Stress-Free Denial Management​​​</h1>
              <div className="span_work mt-4">
                <span><FaCheckCircle className='icon_work' />Knack Global speaks the language of payers, and can quickly recognize the issues that lead to denials.​</span>
              </div>
              <div className="span_work mt-4">
                <span><FaCheckCircle className='icon_work' />We know how to appeal and get denials reversed, and we’re well-versed in the strategies that will prevent denials from happening in the first place.​</span>
